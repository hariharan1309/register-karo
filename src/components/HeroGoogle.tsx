  ...
  return (
    <div className=" space-y-6 max-w-[700px]">
      <div className="flex flex-row gap-1 items-center">
        ...
        <p className="text-[#181617] font-inter">Google Rating</p>
        {[1, 2, 3, 4, 5].map((item) => (
          <HeroStar key={item} />
        ))}
      </div>
      ...
      <div className="relative">
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="absolute right-[240px] mt-1"
        >
          <path
        ...
        <p className="absolute left-[60px] w-fit font-extrabold text-[22px] text-transparent bg-clip-text bg-[linear-gradient(127.81deg,#FFA229_10%,#1C4670_68%)]">
          4.5+
        </p>
        <p className="absolute left-[270px] w-fit font-extrabold text-[22px] text-transparent bg-clip-text bg-[linear-gradient(127.81deg,#FFA229_10%,#1C4670_68%)]">
          20,000+
        </p>
        <p className=" absolute  left-[470px] w-fit font-extrabold text-[22px] text-transparent bg-clip-text bg-[linear-gradient(127.81deg,#FFA229_10%,#1C4670_68%)]">
          99.8%+
        </p>
      ...
      <div className="flex flex-row items-center gap-4">
        ...
        <div className=" flex flex-row items-center gap-4">
          ...
          <p className="text-[#282828] font-inter font-semibold text-base">
            See how it works
          </p>
        </div>
      </div>
