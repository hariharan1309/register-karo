    ...
    <div className="space-y-4 sm:space-y-5 lg:space-y-6 max-w-full sm:max-w-[500px] md:max-w-[600px] lg:max-w-[700px] pb-4 sm:pb-6 lg:pb-8">
      ...
      <div className="relative">
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="absolute right-[20%] sm:right-[180px] lg:right-[240px] mt-1 size-8 max-sm:top-[-4px] sm:w-[45px] sm:h-[45px] lg:w-[50px] lg:h-[50px]"
        >
          <path
        ...
        <p className="absolute left-[30px]  max-sm:top-[-4px] sm:left-[40px] lg:left-[60px] w-fit font-extrabold text-base sm:text-xl lg:text-[22px] text-transparent bg-clip-text bg-[linear-gradient(127.81deg,#FFA229_10%,#1C4670_68%)]">
          4.5+
        </p>
        <p className="absolute left-[155px]  max-sm:top-[-4px] sm:left-[210px] lg:left-[270px] w-fit font-extrabold text-base sm:text-xl lg:text-[22px] text-transparent bg-clip-text bg-[linear-gradient(127.81deg,#FFA229_10%,#1C4670_68%)]">
          20,000+
        </p>
        <p className="absolute left-[280px]  max-sm:top-[-4px] sm:left-[370px] lg:left-[470px] w-fit font-extrabold text-base sm:text-xl lg:text-[22px] text-transparent bg-clip-text bg-[linear-gradient(127.81deg,#FFA229_10%,#1C4670_68%)]">
          99.8%+
        </p>
