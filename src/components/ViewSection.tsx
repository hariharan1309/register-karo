...
const ViewSection = () => {
  return (
    <div className="bg-[#1C4670] grid grid-cols-2 gap-10 p-16 *:font-inter">
      <div className="grid grid-cols-1 gap-8 py-2 max-w-[572px] h-[360px]">
        <div className="grid grid-cols-1 gap-4">
          <h1 className="font-bold text-4xl leading-10 text-white">
      ...
      <div className="relative">
        <img src={Video} alt="" className="h-[420px] " />
        <img
          src={Yt}
          alt=""
          className="absolute top-[145px] w-[154px] right-2/5 mr-1"
        />
        <div className="absolute w-[94.7%] rounded-t-xl inset-0 bg-gradient-to-b from-[rgba(20,120,241,0.35)] from-[45.74%] to-black to-[92.94%]"></div>
      </div>
    </div>
  );
};
