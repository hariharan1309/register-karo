...
const FAQSection = lazy(() => import("./components/FQASection"));
const MobileAppSection = lazy(() => import("./components/MobileSection"));
const StatsSection = lazy(() => import("./components/StatSection"));
